...
# 🤖 Agent Stack Execution Skill (v5.0)
...
4. **Layer 4 — Step-by-Step Roadmap (Plan)**
   ...
   - **CRITICAL GATEKEEPER**: The agent must pause execution and request manual user sign-off (`🔴 Checkpoint`) prior to modifying any physical code files.
