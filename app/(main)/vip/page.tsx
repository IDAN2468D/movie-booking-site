...
import { LiveSeatAuctionArena } from '@/components/vip/LiveSeatAuctionArena';
import { Zap, TrendingUp, ShieldCheck, Gift, Gavel } from 'lucide-react';
    ...
    <div className="relative min-h-screen bg-[#0A0A0A] overflow-hidden text-right pb-32" dir="rtl">
      ...
      <div className="max-w-5xl mx-auto px-4 mb-12">
        <div className="flex flex-wrap items-center justify-center gap-3 p-3 rounded-2xl bg-neutral-950/60 backdrop-blur-[30px] border border-white/10 shadow-2xl">
          <a href="#auction" className="flex items-center gap-2 px-4 py-2 rounded-xl bg-amber-500/20 hover:bg-amber-500/30 text-amber-300 text-xs font-bold font-outfit border border-amber-500/40 transition-all">
            <Gavel size={14} />
            זירת מכרז VIP
          </a>
      ...
      <div id="auction" className="max-w-5xl mx-auto px-4 mb-12">
        <LiveSeatAuctionArena />
      </div>
