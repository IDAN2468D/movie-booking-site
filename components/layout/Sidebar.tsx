...
const featureNavItems: FeatureNavItem[] = [
  ...
  { icon: Headphones, label: 'פרשנות במאי קולית AI 🎙️', href: '/directors-cut' },
  { icon: Gem, label: 'כספת שברי זיכרון דיגיטליים 💎', href: '/memory-capsules' },
  { icon: Subtitles, label: 'כתוביות חיות ותרגום AI 🎬', href: '/cinesub' },
  { icon: Sparkles, label: 'מעבדת העתיד הקולנועית 🚀', href: '/showcase/master-suite' },
  { icon: Zap, label: 'גבול חשמלי ואינדיקטורים ⚡', href: '/electric-border' },
  { icon: Gamepad2, label: 'משחק התאמת מושבים 🎮', href: '/booking/seating-game' },
  { icon: Sparkles, label: 'האופק התחושתי והסנסורי ✨', href: '/sensory-horizon' },
  { icon: Activity, label: 'מרכז התהודה והרטט ההפטי 📳', href: '/haptic' },
  { icon: Shield, label: 'תא האורה הביומטרי 🛡️', href: '/aura-chamber' },
  { icon: Disc3, label: 'סינתיסייזר פסקול קוונטי 🎵', href: '/soundtrack-synth' },
  { icon: Users, label: 'מרכז הסנכרון הקבוצתי 👥', href: '/nexus' },
  { icon: Volume2, label: 'כיול תהודה אקוסטית באולם 🔊', href: '/prelude' },
  { icon: Sparkles, label: 'חוויה קולנועית רב-חושית 🌌', href: '/transcendent' },
  { icon: Languages, label: 'מנוע כתוביות ותרגום מתקדם 🌐', href: '/subtitles' },
  { icon: Trophy, label: 'כספת גביעים והישגים 🏆', href: '/trophy-vault' },
  { icon: Mic, label: 'פקודות קוליות AI 🎙️', href: '/voice-shell' },
  { icon: Users, label: 'התאמת צפייה שיתופית 🤝', href: '/discover/coop' },
  { icon: Disc3, label: 'פסקולים ומוזיקה קולנועית 🎶', href: '/soundtracks' },
  { icon: Zap, label: 'מנוע התאמת סרטים אישי 🎯', href: '/showcase' },
  { icon: Compass, label: 'גילוי נוירוני ומצבי רוח 🧠', href: '/discovery' },
  { icon: Newspaper, label: 'מבזקי קולנוע וביקורות 📰', href: '/news' },
  { icon: Share2, label: 'פיצול וסליקת כרטיסים 💳', href: '/splinter-demo' },
];
